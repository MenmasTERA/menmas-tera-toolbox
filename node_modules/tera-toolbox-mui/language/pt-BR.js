...
function GetString(str, tokens) {
    switch (str) {
        ...
        // loader-cli
        case 'loader-cli/error-node-too-old-1': return 'ERRO: Sua versão de Node.JS é muito antiga para fazer MT: The Dream Toolbox funcionar!';
        case 'loader-cli/error-node-too-old-2': return 'ERRO: Por favor, baixe e reinstale MT: The Dream Toolbox, ou instale a última versão de Node.JS de https://nodejs.org/en/download/current/';
        ...
        case 'loader-cli/error-migration-failed-1': return 'ERRO: Não foi possível migrar os arquivos desde a versão anterior de MT: The Dream Toolbox!';
        ...
        case 'loader-gui/error-config-file-corrupt/message': return `O arquivo config.json na sua pasta de MT: The Dream Toolbox está malformado. Tente consertar você mesmo, delete-o para gerar um novo, ou pergunte em ${tokens.supportUrl} para receber ajuda!\n\n O programa será terminado agora.`;
        case 'loader-gui/error-migration-failed/title': return 'Erro de migração!';
        case 'loader-gui/error-migration-failed/message': return `Não foi possível migrar arquivos desde uma versão anterior de MT: The Dream Toolbox.\nPor favor, reinstale uma versão limpa usando o último instalador ou pergunte em ${tokens.supportUrl} para obter ajuda!\n\nO programa será terminado agora.`;
        ...
        case 'proxy/client-interface-error-EADDRINUSE': return '[toolbox] ERRO: Outra instância de MT: The Dream Toolbox já está sendo executada. Por favor, feche-a ou reinicie o seu computador e tente novamente!';
        ...
        case 'gui/main/status-update-available': return 'ATUALIZAÇÃO DISPONÍVEL - POR FAVOR REINICIE MT: The Dream Toolbox';
        ...
        case 'gui/main/modal/warn-self-update-disabled': return 'Atenção! Você desativou as atualizações automáticas para MT: The Dream Toolbox. Isso irá criar problemas no futuro. Não iremos prover assistência se não ativar novamente!';
        case 'gui/main/modal/error-cannot-install-mod-while-running': return 'Você não pode instalar módulos enquanto MT: The Dream Toolbox está rodando. Por favor, pare o proxy primeiro!';
        case 'gui/main/modal/error-cannot-uninstall-mod-while-running': return 'Você não pode desinstalar módulos enquanto MT: The Dream Toolbox está rodando. Por favor, pare o proxy primeiro!';
        ...
        case 'gui/main/static/tabs/settings/content/autostart': return 'Auto-iniciar ao abrir MT: The Dream Toolbox';
        ...
        case 'gui/main/static/tabs/settings/content/noselfupdate': return 'Desativar as atualizações de MT: The Dream Toolbox';
        ...
        case 'tera-client-interface/gpkmanager/symlink-warning-1': return '[toolbox] ATENÇÃO: Parece que ou MT: The Dream Toolbox ou o jogo estão num disco ou partição que';
        ...
        case 'mod/settings-load-error-corrupted-4': return 'Por favor, lembre-se de fechar o programa corretamente: Primeiramente feche o jogo e então feche MT: The Dream Toolbox apertando o X!';
        case 'mod/settings-load-error-corrupted-5': return 'Não desligue o computador enquanto MT: The Dream Toolbox estiver rodando!';
