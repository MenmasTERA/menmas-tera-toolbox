...
function GetString(str, tokens) {
    switch (str) {
        ...
        // loader-cli
        case 'loader-cli/error-node-too-old-1': return 'FEHLER: Deine installierte Version von Node.js ist zu alt, um MT: The Dream Toolbox auszuführen!';
        case 'loader-cli/error-node-too-old-2': return 'FEHLER: Bitte downloade und installiere MT: The Dream Toolbox erneut, oder installiere die neueste Version von Node.js mit dem folgenden Link https://nodejs.org/en/download/current/';
        ...
        case 'loader-cli/error-migration-failed-1': return 'FEHLER: Dateien einer veralteten Version von MT: The Dream Toolbox konnten nicht migriert werden!';
        ...
        case 'loader-gui/error-config-file-corrupt/message': return `Die Datei config.json im MT: The Dream Toolbox Ordner ist beschädigt. Versuche den Fehler selbst zu beheben, lösche sie um eine neue zu generieren, oder bitte hier ${tokens.supportUrl} um Hilfe!\n\nDas Programm wird jetzt beendet.`;
        case 'loader-gui/error-migration-failed/title': return 'Migrationsfehler!';
        case 'loader-gui/error-migration-failed/message': return `Dateien einer veralteten Version von MT: The Dream Toolbox konnten nicht migriert werden!\nInstalliere eine saubere Kopie mit dem neuesten Installationsprogramm oder bitte hier ${tokens.supportUrl} um Hilfe!\n\nDas Programm wird jetzt beendet.`;
        ...
        case 'proxy/client-interface-error-EADDRINUSE': return '[Toolbox] FEHLER: Eine andere Instanz von MT: The Dream Toolbox wird bereits ausgeführt. Bitte schließe sie oder starte deinen Computer neu und versuche es erneut!';
        ...
        case 'gui/main/modal/error-cannot-install-mod-while-running': return 'Du kannst keine Module installieren, während MT: The Dream Toolbox ausgeführt wird. Bitte zuerst stoppen!';
        case 'gui/main/modal/error-cannot-uninstall-mod-while-running': return 'Du kannst keine Module deinstallieren, während MT: The Dream Toolbox ausgeführt wird. Bitte zuerst stoppen!';
        ...
        case 'tera-client-interface/gpkmanager/symlink-warning-1': return '[Toolbox] WARNUNG: Es sieht so aus, als ob sich entweder MT: The Dream Toolbox oder das Spiel auf einem Laufwerk / einer Partition befinden,';
        ...
        case 'mod/settings-load-error-corrupted-4': return 'Bitte denke daran, das Programm ordnungsgemäß zu schließen: Schließe zuerst das Spiel und dann MT: The Dream Toolbox mit dem X-Knopf!';
        case 'mod/settings-load-error-corrupted-5': return 'Fahre deinen Computer nicht herunter, während MT: The Dream Toolbox ausgeführt wird!';
