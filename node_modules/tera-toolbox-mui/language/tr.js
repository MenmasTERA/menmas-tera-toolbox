...
function GetString(str, tokens) {
    switch (str) {
        ...
        case 'loader-cli/error-migration-failed-1': return 'HATA: MT: The Dream Toolboxun eski versiyonlarından dosya aktarımı başarısız oldu!';
        ...
        case 'gui/main/modal/warn-self-update-disabled': return 'Uyarı! MT: The Dream Toolbox için otomatik güncellemeleri devre dışı bıraktınız. Bu durum bir noktadan sonra bazı bozukluklar yaratacaktır. Otomatik güncelleştirmeler tekrar etkinleştirilene kadar destek sağlamayacağız!';
        case 'gui/main/modal/error-cannot-install-mod-while-running': return 'MT: The Dream Toolbox çalışırken herhangi bir mod yükleyemezsiniz. Lütfen önce durdurun!';
        case 'gui/main/modal/error-cannot-uninstall-mod-while-running': return 'MT: The Dream Toolbox çalışırken mod herhangi bir mod kaldıramazsınız. Lütfen önce durdurun!';
        ...
        case 'gui/main/static/tabs/settings/content/autostart': return 'MT: The Dream Toolbox basladığında otomatik çalıştır';
        ...
        case 'tera-client-interface/gpkmanager/symlink-warning-1': return '[ToolBox] UYARI: Görünüşe göre MT: The Dream Toolbox veya oyun sembolik köprüleri desteklemeyen';
