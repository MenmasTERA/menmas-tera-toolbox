...
function GetString(str, tokens) {
    switch (str) {
        ...
        // loader-cli
        case 'loader-cli/error-node-too-old-1': return 'ERROR: Your installed version of Node.JS is too old to run MT: The Dream Toolbox!';
        case 'loader-cli/error-node-too-old-2': return 'ERROR: Please redownload and reinstall MT: The Dream Toolbox, or install the latest version of Node.JS from https://nodejs.org/en/download/current/';
        ...
        case 'loader-cli/error-migration-failed-1': return 'ERROR: Unable to migrate files from an old version of MT: The Dream Toolbox!';
        ...
        case 'loader-gui/error-config-file-corrupt/message': return `The config.json file in your MT: The Dream Toolbox folder is malformed. Try to fix it yourself, delete it to generate a new one, or ask in ${tokens.supportUrl} for help!\n\nThe program will now be terminated.`;
        case 'loader-gui/error-migration-failed/title': return 'Migration error!';
        case 'loader-gui/error-migration-failed/message': return `Unable to migrate files from an old version of MT: The Dream Toolbox.\nPlease reinstall a clean copy using the latest installer or ask in ${tokens.supportUrl} for help!\n\nThe program will now be terminated.`;
        ...
        case 'proxy/client-interface-error-EADDRINUSE': return '[toolbox] ERROR: Another instance of MT: The Dream Toolbox is already running. Please close it or restart your computer and try again!';
        ...
        case 'gui/main/title': return 'MT: The Dream Toolbox';
        ...
        case 'gui/main/modal/warn-self-update-disabled': return 'Warning! You disabled automatic updates for MT: The Dream Toolbox. This will break things at some point. We will not provide any assistance unless re-enabled!';
        case 'gui/main/modal/error-cannot-install-mod-while-running': return 'You cannot install mods while MT: The Dream Toolbox is running. Please stop it first!';
        case 'gui/main/modal/error-cannot-uninstall-mod-while-running': return 'You cannot uninstall mods while MT: The Dream Toolbox is running. Please stop it first!';
        ...
        case 'gui/main/static/tabs/mods/unsupported-warning-title': return 'Warning!';
        case 'gui/main/static/tabs/mods/unsupported-warning-message': return 'The only officially supported mods are the ones that are already pre-installed, as well as mods listed in the "Get More Mods" tab. Any other mod is considered unsupported. Cheats, scripts, hacks and/or software that provide an advantage over your co-players are strictly prohibited. MT: The Dream team reserves every right to restrict your account from accessing the game indefinitely, if they determine usage of any kind of unsupported mods.';
        ...
        case 'gui/main/static/tabs/settings/toolbox': return 'MT: The Dream Toolbox:';
        ...
        case 'gui/main/static/tabs/settings/content/autostart': return 'Autostart when opening MT: The Dream Toolbox';
        ...
        case 'gui/main/static/tabs/settings/content/cleanstart': return 'Clean log every MT: The Dream Toolbox start';
        ...
        case 'tera-client-interface/gpkmanager/symlink-warning-1': return '[toolbox] WARNING: It looks like either MT: The Dream Toolbox or the game are located on a drive / partition that does';
        ...
        case 'mod/settings-load-error-corrupted-4': return 'Please remember to close the program properly: first close the game, then close MT: The Dream Toolbox using the X button!';
        case 'mod/settings-load-error-corrupted-5': return 'Do not shut down your computer while MT: The Dream Toolbox is running!';
