...
function GetString(str, tokens) {
    switch (str) {
        ...
        // loader-cli
        case 'loader-cli/error-node-too-old-1': return 'ERRORE: La versione di node.js è troppo vecchia per eseguire MT: The Dream Toolbox!';
        case 'loader-cli/error-node-too-old-2': return 'ERRORE: Riscarica e reinstalla MT: The Dream Toolbox, o installa l\'ultima versione di node.js da https://nodejs.org/en/download/current/';
        ...
        case 'loader-cli/error-migration-failed-1': return 'ERRORE: Impossibile migrare file da una versione precedente di MT: The Dream Toolbox!';
        ...
        case 'loader-gui/error-config-file-corrupt/message': return `Il file config.json nella tua cartella di MT: The Dream Toolbox non è valido. Prova a correggerlo, o a cancellarlo per generarne uno nuovo, o chiedi aiuto in ${tokens.supportUrl}!\n\nIl programma sarà terminato.`;
        case 'loader-gui/error-migration-failed/title': return 'Errore di migrazione!';
        case 'loader-gui/error-migration-failed/message': return `Impossibile migrare file da una versione precedente di MT: The Dream Toolbox.\nReinstalla utilizzando l'ultimo installer o chiedi aiuto in ${tokens.supportUrl}!\n\nIl programma sarà terminato.`;
        ...
        case 'loader-gui/warning-noselfupdate-2': return '!!!!!       HAI DISATTIVATO GLI AGGIORNAMENTI AUTOMATICI DI MT: The Dream Toolbox       !!!!!';
        ...
        case 'proxy/client-interface-error-EADDRINUSE': return '[toolbox] ERRORE: Un\'altra istanza di MT: The Dream Toolbox è già in esecuzione. Chiudila o riavvia il computer e riprova!';
        ...
        case 'gui/main/modal/warn-self-update-disabled': return 'Attenzione! Hai disattivato gli aggiornamenti automatici di MT: The Dream Toolbox. Questo causerà problemi in futuro.  Non forniremo alcuna assistenza a meno che non li riabiliti!';
        case 'gui/main/modal/error-cannot-install-mod-while-running': return 'Non puoi installare mod mentre MT: The Dream Toolbox è in esecuzione. Arrestalo prima!';
        case 'gui/main/modal/error-cannot-uninstall-mod-while-running': return 'Non puoi disinstallare mod mentre MT: The Dream Toolbox è in esecuzione. Arrestalo prima!';
        ...
        case 'tera-client-interface/gpkmanager/symlink-warning-1': return '[toolbox] ATTENZIONE: Sembra che MT: The Dream Toolbox o il gioco si trovino in un disco / partizione che non';
        ...
        case 'mod/settings-load-error-corrupted-4': return 'Ricorda di chiudere il programma in maniera appropriata: prima chiudi il gioco, poi MT: The Dream Toolbox usando la X!';
        case 'mod/settings-load-error-corrupted-5': return 'Non spegnere il computer mentre MT: The Dream Toolbox è in esecuzione!';
