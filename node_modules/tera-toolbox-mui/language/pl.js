...
function GetString(str, tokens) {
    switch (str) {
        ...
        // loader-cli
        case 'loader-cli/error-node-too-old-1': return 'BŁĄD: Twoja obecnie zainstalowana wersja Node.JS jest zbyt stara, aby uruchomić MT: The Dream Toolbox!';
        case 'loader-cli/error-node-too-old-2': return 'BŁĄD: Proszę pobrać i zainstalować ponownie MT: The Dream Toolbox, lub zainstalować najnowszą wersję Node.JS z https://nodejs.org/en/download/current/';
        ...
        case 'loader-cli/error-migration-failed-1': return 'BŁĄD: Wystąpił problem z migracją plików ze starej wersji MT: The Dream Toolbox!';
        ...
        case 'loader-gui/error-config-file-corrupt/message': return `Plik config.json w folderze MT: The Dream Toolbox jest zjebany. Spróbuj naprawić to samodzielnie, usuń go aby wygenerować nowy, albo spytaj o pomoc tutaj: ${tokens.supportUrl} \n\nProgram zostanie teraz zakończony.`;
        case 'loader-gui/error-migration-failed/title': return 'Błąd migracji!';
        case 'loader-gui/error-migration-failed/message': return `Wystąpił problem z migracją plików ze starej wersji MT: The Dream Toolbox.\nProszę zainstalować czystą kopię używając najnowszego instalatora, lub zapytać o pomoc tutaj: ${tokens.supportUrl} \n\nProgram zostanie teraz zakończony.`;
        ...
        case 'proxy/client-interface-error-EADDRINUSE': return '[toolbox] BŁĄD: Inny proces MT: The Dream Toolbox jest nadal uruchomiony. Proszę go zamknąć lub zrestartować komputer i spróbować ponownie!';
        ...
        case 'gui/main/modal/warn-self-update-disabled': return 'Ostrzeżenie! Wyłączyłeś/aś automatyczne aktualizacje dla MT: The Dream Toolbox. Prędzej czy później spowoduje to problemy, dla których nie zapewnimy wsparcia, dopóki nie włączysz aktualizacji ponownie!';
        case 'gui/main/modal/error-cannot-install-mod-while-running': return 'Nie możesz zainstalować modów podczas gdy MT: The Dream Toolbox jest uruchomiony. Proszę najpierw go zatrzymać!';
        case 'gui/main/modal/error-cannot-uninstall-mod-while-running': return 'Nie możesz odinstalować modów podczas gdy MT: The Dream Toolbox jest uruchomiony. Proszę najpierw go zatrzymać!';
        ...
        case 'gui/main/static/tabs/settings/content/autostart': return 'Autostart przy otwieraniu MT: The Dream Toolbox';
        ...
        case 'tera-client-interface/gpkmanager/symlink-warning-1': return '[toolbox] OSTRZEŻENIE: Wygląda na to, że MT: The Dream Toolbox lub gra są zlokalizowane na dysku/partycji, która nie wspiera';
        ...
        case 'mod/settings-load-error-corrupted-4': return 'Proszę pamiętaj o poprawnym zamykaniu programu: po pierwsze, primo, zamknij grę; po drugie, primo, zamknij MT: The Dream Toolbox używając przycisku X!';
        case 'mod/settings-load-error-corrupted-5': return 'Po trzecie, primo ULTIMO; nie wyłączaj swojego komputera podczas gdy MT: The Dream Toolbox jest uruchomiony!';
