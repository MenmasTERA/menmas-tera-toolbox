...
function GetString(str, tokens) {
    switch (str) {
        ...
        case 'gui/main/title': return 'MT: The Dream 工具箱';
		case 'gui/main/title/admin': return 'MT: The Dream工具箱 [管理员运行模式]';
        case 'gui/main/title/noadmin': return 'MT: The Dream工具箱[普通运行模式]';
