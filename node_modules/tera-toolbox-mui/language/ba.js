...
function GetString(str, tokens) {
    switch (str) {
        ...
        // loader-cli
        case 'loader-cli/error-node-too-old-1': return 'GREŠKA: Tvoja verzina Nodule.JS je prestara za pokretanje MT: The Dream Toolbox!';
        case 'loader-cli/error-node-too-old-2': return 'GREŠKA: Molimo preuzmite i instalirajte ponovo MT: The Dream Toolbox, ili instaliraj noviju verziju Node.JS iz https://nodejs.org/en/download/current/';
        ...
        case 'loader-cli/error-migration-failed-1': return 'GREŠKA: Nemoguće migrirati fajlove sa stare verzije MT: The Dream Toolbox!';
        case 'loader-cli/error-migration-failed-2': return 'GREŠKA: Molimo instalirajte najnoviju verziju MT: The Dream Toolbox!';
        ...
        case 'loader-gui/error-config-file-corrupt/message': return `config.json fajl u tvoj MT: The Dream Toolbox folder je nepravilan. Pokušaj popraviti sam, obriši da napravi se novi, ili pitaj ovdje ${tokens.supportUrl} za pomoć!\n\nProgram će se sad isključiti.`;
        case 'loader-gui/error-migration-failed/title': return 'Migracijska greška!';
        case 'loader-gui/error-migration-failed/message': return `Nemoguće migrirati fajlove sa stare verzije MT: The Dream Toolbox.\nMolimo instalirati sviježu kopiju ili pitati na ${tokens.supportUrl} for help!\n\nProgram će se sad isključiti.`;
        ...
        case 'proxy/client-interface-error-EADDRINUSE': return '[toolbox] GREŠKA: Drugi program MT: The Dream Toolbox je već pokrenuta. Molimo isključite je ili resetirajte kompjuter!';
        ...
        case 'gui/main/modal/warn-self-update-disabled': return 'Upozorenje! Iključio si automatsko ažuriranje za MT: The Dream Toolbox. Može pokvariti dosta stvari sa vremenom. Nećemo pružiti pomoć sve dok ne upalite automatsko ažuriranje!';
        ...
        case 'tera-client-interface/gpkmanager/symlink-warning-1': return '[toolbox] UPOZORENJE: Izgleda da se MT: The Dream Toolbox ili igra nalaze na pogonu / particiji koja čini';
        ...
        case 'mod/settings-load-error-corrupted-5': return 'Nemojte isključi kompjuter dok MT: The Dream Toolbox je pokrenut!';
