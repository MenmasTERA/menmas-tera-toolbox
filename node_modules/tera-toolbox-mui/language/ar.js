...
function GetString(str, tokens) {
    switch (str) {
        ...
        // loader-cli
        case 'loader-cli/error-node-too-old-1': return 'MT: The Dream Toolbox! قديم جدًا لتشغيل Node.JS خطأ: إصدارك المثبت من';
        case 'loader-cli/error-node-too-old-2': return 'https://nodejs.org/ar/download/current/ من Node.JS وإعادة تثبيته، أو تثبيت أحدث إصدار من MT: The Dream Toolbox خطأ: يرجى إعادة تحميل';
        ...
        case 'loader-cli/error-migration-failed-1': return 'MT: The Dream Toolbox! خطأ: غير قادر على ترحيل الملفات من إصدار قديم من';
        ...
        case 'loader-gui/error-config-file-corrupt/message': return `. ${tokens.supportUrl} :غير صالح. حاول إصلاحة بنفسك أو قم بحذفه لإنشاء ملف جديد أو أطلب المساعدة هنا MT: The Dream Toolbox فى مجلد config.json ملف \n\n .سيتم الآن إنهاء البرنامج`;
        case 'loader-gui/error-migration-failed/title': return '!خطأ فى ترحيل الملفات';
        case 'loader-gui/error-migration-failed/message': return `.MT: The Dream Toolbox يتعذر ترحيل الملفات من الإصدارقديم من \n . ${tokens.supportUrl} الرجاء إعادة تثبيت نسخة نظيفة باستخدام أحدث مثبت أو اطلب المساعدة هنا \n \n .سيتم الآن إنهاء البرنامج`;
        ...
        case 'proxy/client-interface-error-EADDRINUSE': return '[toolbox] !قيد التشغيل بالفعل. الرجاء إغلاقه أو إعادة تشغيل جهاز الكمبيوتر والمحاولة مرة أخرى MT: The Dream Toolbox هناك مثيل آخر لـ';
        ...
        case 'gui/main/modal/warn-self-update-disabled': return '! ذلك سوف يعطل الأشياء فى مرحلة ما. لن نقدم أي مساعدة ما لم تتم إعادة التفعيل .MT: The Dream Toolbox تحذير! قمت بتعطيل التحديثات التلقائية ل';
        case 'gui/main/modal/error-cannot-install-mod-while-running': return '! يعمل. يرجى إيقافه أولاً MT: The Dream Toolbox لا يمكنك تثبيت التطبيقات و';
        case 'gui/main/modal/error-cannot-uninstall-mod-while-running': return '! يعمل. يرجى إيقافه أولاً MT: The Dream Toolbox لا يمكنك إلغاء تثبيت التطبيقات و';
        ...
        case 'gui/main/static/tabs/settings/content/autostart': return 'MT: The Dream Toolbox التفعيل التلقائي عند فتح';
        ...
        case 'tera-client-interface/gpkmanager/symlink-warning-1': return '[toolbox]  أو اللعبة موجودة على محرك / قسم موجود MT: The Dream Toolbox تحذير: يبدو أن';
        ...
        case 'mod/settings-load-error-corrupted-4': return '!X باستخدام الزر MT: The Dream Toolbox يرجى تذكر إغلاق البرنامج بشكل صحيح: أولاً أغلق اللعبة، ثم أغلق';
        case 'mod/settings-load-error-corrupted-5': return '! MT: The Dream Toolbox لا تقم بإغلاق جهاز الكمبيوتر الخاص بك أثناء عمل';
