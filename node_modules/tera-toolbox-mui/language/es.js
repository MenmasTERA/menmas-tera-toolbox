...
function GetString(str, tokens) {
    switch (str) {
        ...
        // loader-cli
        case 'loader-cli/error-node-too-old-1': return 'ERROR: Tu versión instalada de Node.js es muy vieja y/o incompatible con MT: The Dream Toolbox!';
        case 'loader-cli/error-node-too-old-2': return 'ERROR: Por favor, descarga e instala MT: The Dream Toolbox nuevamente o instala la ultima versión de Node.js en https://nodejs.org/en/download/current/';
        ...
        case 'loader-cli/error-migration-failed-1': return 'ERROR: No se pudieron migrar los archivos de una versión anterior de MT: The Dream Toolbox!';
        ...
        case 'loader-gui/error-config-file-corrupt/message': return `El archivo config.json en tu carpeta de MT: The Dream Toolbox está corrupto. Intenta arreglarlo tu mismo, borrarlo para generar uno nuevo o pregunta en ${tokens.supportUrl} para recibir ayuda!\n\nEl programa se cerrara ahora.`;
        ...
        case 'proxy/client-interface-error-EADDRINUSE': return '[toolbox] ERROR: MT: The Dream Toolbox ya se está ejecutando en el sistema. Por favor cierrala o reinicia tu PC e intenta de nuevo!';
        ...
        case 'gui/main/modal/warn-self-update-disabled': return 'Atención! Has desactivado las actualizaciones automáticas para MT: The Dream Toolbox. Esto traerá problemas eventualmente. No proveeremos ayuda hasta re-activar esta función!';
        case 'gui/main/modal/error-cannot-install-mod-while-running': return 'No puedes instalar módulos mientras MT: The Dream Toolbox esta funcionando, por favor detenlo para continuar!';
        case 'gui/main/modal/error-cannot-uninstall-mod-while-running': return 'No puedes desinstalar módulos mientras MT: The Dream Toolbox esta funcionando, por favor detenlo para continuar!';
        ...
        case 'gui/main/static/tabs/settings/content/autostart': return 'Iniciar automaticamente al abrir MT: The Dream Toolbox';
        ...
        case 'gui/main/static/tabs/settings/content/noselfupdate': return 'Desactivar las actualizaciones de MT: The Dream Toolbox';
        ...
        case 'gui/main/static/tabs/settings/content/cleanstart': return 'Limpiar el registro cada vez que se inicia MT: The Dream Toolbox ';
        ...
        case 'tera-client-interface/gpkmanager/symlink-warning-1': return '[toolbox] ATENCIÓN: Parece que MT: The Dream Toolbox o el juego están ubicados en un disco / particion que';
        ...
        case 'mod/settings-load-error-corrupted-4': return 'Por favor recuerda cerrar el programa de manera correcta: primero cierra el juego, luego cierra MT: The Dream Toolbox utilizando el botón X!';
        case 'mod/settings-load-error-corrupted-5': return 'No apagues tu PC cuando MT: The Dream Toolbox se esté ejecutanmdo!';
